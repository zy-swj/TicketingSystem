...
<head>
    ...
    <script>
        ...
        function endorse_Tickets(train_no,from_station_no,to_station_no,seat_types,station_train_code,from_station_name,to_station_name,start_time){
            if(${sessionScope._USER_.user_name == null}){
                ...
                $.ajax({
                    url:"${pageContext.request.contextPath}/tickets/endorseTickets.action",
                    data:tickets,
                    type:'post',
    ...
    <from role="form">
        <div style="width:250px;">
            ...
            <div class="input-group form-group" style="margin-top: 10px;">
                ...
                <span class="input-group-btn"><button class="btn btn-default form-control" onclick="endorse_change();"><span class=" glyphicon glyphicon-refresh"></span></button></span>
            ...
            <button class="btn btn-default btn-block form-control" type="button"
                    style="background-color: #ff8c00;color:#ffffff" onclick="endorse_query();">查询</button>
        </div>
